...
<!--Задание 5.4-5.5 Заменить содержимое таблицы данными из массива задач-->
            <table class="tasks">
            <?php foreach ($list_tasks as $key => $val) : ?> 
            <?php 
                if ($val['perfomance'] == 'Да') { 
                    continue; 
                    } 
            ?> 
                <tr class="tasks__item task <?php if ($val['perfomance'] == 'Да') : ?>task--completed<?php endif; ?>"> 
                <td class="task__select"> 
                    <label class="checkbox task__checkbox"> 
                    <input class="checkbox__input visually-hidden task__checkbox" type="checkbox" value="1" >
            <?php if ($val['perfomance'] == 'Да') : ?>checked<?php endif; ?> 
